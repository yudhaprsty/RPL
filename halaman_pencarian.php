<?php
	...
	$sql = "SELECT * FROM penjualan WHERE nama_produk like '%$nama_produk%'";
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Halaman Pencarian</li>
			</ol>
		</div>
	</div>
									...
									<figure>
										<div class="snipcart-item block">
											<div class="snipcart-thumb">
												<a href="halaman_produk_satuan.php?id=<?php echo $result1['id'] ?>"> <?php echo "<img src = 'produk/".$data['produk']."'>"; ?> </a>
												</br>
