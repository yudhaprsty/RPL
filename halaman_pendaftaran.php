...
<!-- //header -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<h6>Informasi Utama</h6>
					...
					<input type="password" placeholder="Konfrimasi Kata Sandi" required=" " >
					<div class="register-check-box">
						<div class="check">
							<label class="checkbox"><input type="checkbox" name="checkbox"><i> </i>Saya menerima syarat dan ketentuan yang berlaku</label>
						</div>
					</div>
	...
	<!--Selesai bagian utaama register-->
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2017 Halaman Pendaftaran Kelompok 8</p>
			</div>
		</div>
